...
echo "*        Signing          *"
echo "***************************"
xcodebuild -exportArchive -sdk iphoneos -archivePath ArchiveFolder/travis-ci-ex.xcarchive -exportPath "$OUTPUTDIR" -exportOptionsPlist "$PROJECT_DIRECTORY/ipa.plist"
